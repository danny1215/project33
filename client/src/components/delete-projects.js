...
export default class DeleteProject extends Component {
    ...
    onSubmit(e) {
        ...
        console.log(obj);
        axios.delete('http://localhost:3001/project/delete/'+this.props.match.params.id, obj)
    ...
    render() {
        return (
            <div>
                <h3 align="center">ARE YOU SURE YOU WANT TO Delete A Project ?</h3>
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <input type="submit" value="Delete Project" className="btn btn-primary" />
                    </div>
